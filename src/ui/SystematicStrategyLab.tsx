      ...
      <main className="systematic-lab-profile-editor">
        {draft ? <section className="systematic-lab-profile-editor__content">
          ...
          <div className="systematic-lab-profile-editor__group">
            ...
            <label className="systematic-lab-field"><span>{text.contract}<small>{text.contractWatchlistOnly}</small></span><ProfileInstrumentSelect value={draft.instId} options={watchlist} disabled={!profileEditable} text={text} onChange={(instId) => updateDraft({ instId })} /></label>
...
function copy(chinese: boolean) {
  ...
  return {
    ...
    virtualAccount: "VIRTUAL ACCOUNT", workers: "parallel backtest slots", contract: "Contract", contractWatchlistOnly: "Only markets already in your watchlist can be selected", initialEquity: "Initial equity", leverage: "Leverage", marginSafetyMultiplier: "Margin safety multiplier", preloadHistory: "Preloaded history", preloadScope: "Preload range", preloadBeforeStart: "before evaluation start", preloadExcluded: "Excluded from equity, replay, and statistics", start: "Evaluation start", end: "Evaluation end", backtestRangeQuick: "Quick range", recentOneMonth: "1 month", recentThreeMonths: "3 months", recentOneYear: "1 year", thisYear: "This year", lastYear: "Last year", yearBeforeLast: "Year before last",
