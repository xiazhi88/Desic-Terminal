...
> ⚠️ **已被 v3 取代（2026-09-18）**：本文 §3.1 双编排器、§3.2 统一闸门、§5.2 必需专家、§5.6 预算护栏与 P2c/P3/P4 全部作废；当前施工基准是 `docs/multi-agent-dispatch-plan-v3.md` 与 `docs/agent-library-contract.md`。本文只作为设计历史保留，**不得据以实现**。
